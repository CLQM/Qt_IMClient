...
signals:
    ...
    void signalUserLoginCrowdSuccess(UserInfo *info);
    void signalSendMsgtoClient(QByteArray *buffer);
    void signalUserFindFriendSuccess(UserInfo *info);
    void signalUserRegisterSuccess(UserInfo *info);
    void signalUpdateFriendList(void);
    void signalUpdateCrowdList(void);
    void signalUserEditSuccess(UserInfo *info);
    void signalSendMsgtoServer(QByteArray *buffer);
